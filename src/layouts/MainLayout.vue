<template>
  <q-layout view="hhh lpR fff">
    <q-header class="bg-black text-white flex justify-center main" height-hint="98" style="height: 120px">
      <q-toolbar>
        <q-toolbar-title class="text-h2 header_title col-5 text-center">
